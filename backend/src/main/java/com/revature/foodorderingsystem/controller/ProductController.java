...
public class ProductController 
{
							...
							throws RecordNotFoundException 
	{
		...
		final Product updateProduct = productService.createOrUpdateProduct(product);
	...
	@PutMapping("/addOrder/{pid}/{bid}")
	public void addOrder(@PathVariable(value ="pid") long pid, @Valid @RequestBody BillingStatement billingStatement) throws RecordNotFoundException {
	 Product product  = productService.getProductById(pid);
	 product.getBillingStatements().add(billingStatement);
